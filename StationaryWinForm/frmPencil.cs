...
namespace StationaryWinForm
{
    public sealed partial class frmPencil : frmStationary
    {
        ...
        public static void Run(clsAllStationary prPencil)
        {
        ...
        protected override void updateForm()
        {
            ...
            ckbMechanical.Checked = _Stationary.Mechanical;

            //Checks if there's a written value, if not, sets a default
            if (!string.IsNullOrEmpty(_Stationary.LeadGrade))
            {

                cmbLead.SelectedIndex = cmbLead.FindStringExact(_Stationary.LeadGrade);
            } else
            {
        ...
        protected override void pushData()
        {
            base.pushData();
            //clsPencil lcStationary = (clsPencil)this._Stationary;
            _Stationary.Mechanical = ckbMechanical.Checked;
            _Stationary.LeadGrade = cmbLead.Text;
        }
